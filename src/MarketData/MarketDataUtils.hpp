...
namespace MarketData
{
    ...
    {
    public:
        static void log(const Utilities::LogLevel& logLevel, int value, const std::string& message);
        static void log(const Utilities::LogLevel& logLevel, const std::string& message);
