...
namespace BeaconTech::MarketData
{
    ...
    template<typename T>
    MarketDataStreamingClient<T>::MarketDataStreamingClient() : streamingConsumer{createStreamingProcessor()}
    {
    ...
    template<typename T>
    std::shared_ptr<MarketDataProcessor> MarketDataStreamingClient<T>::createStreamingProcessor()
    {
    ...
    template<typename T>
    void MarketDataStreamingClient<T>::initialize(std::shared_ptr<T> marketDataClient, const Common::MdCallback& callback)
    {
