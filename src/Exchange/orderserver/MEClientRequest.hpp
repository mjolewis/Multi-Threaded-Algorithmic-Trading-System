...
#ifndef MULTI_THREADED_ALGORITHMIC_TRADING_SYSTEM_MECLIENTREQUEST_HPP
#define MULTI_THREADED_ALGORITHMIC_TRADING_SYSTEM_MECLIENTREQUEST_HPP
...
#pragma pack(pop)
    ...
    using ClientRequestLFQueue = Common::ConcurrentLockFreeQueue<MEClientRequest>;

} // BeaconTech::Exchange

#endif //MULTI_THREADED_ALGORITHMIC_TRADING_SYSTEM_MECLIENTREQUEST_HPP
